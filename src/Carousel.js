    ...
    useEffect(() => {
        setPages(
            Children.map(children, child => {
                return cloneElement(child, { style: { minHeight: '100%' ,maxHeight: '100%', minWidth: '100%', maxWidth: '100%', },})
            })
        )
    }, []);
    ...
    return (
        <div className='main-window'>
            ...
            {(offset === 0) || (offset === -400)  ? (
                ...
                <div className="allPagesAnimation" style = {{transform: `translateX(${offset}%)` }}>                
                {pages}
            </div>
            }
            </div>
